          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                name="email"
                required
                className="w-full border border-gray-300 px-4 py-2 rounded-sm focus:outline-none focus:border-blue-500 transition-colors"
            ...
            {/* Options: Show Pass & Remember Me (Theo đúng mẫu ảnh 1) */}
            <div className="flex flex-col gap-2">
              ...
              <label className="flex items-center gap-2 cursor-pointer w-fit">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                />
                <span className="text-sm text-gray-600">Lưu lại mật khẩu</span>
              </label>
            </div>

            {/* Login Button (Màu đỏ theo mẫu) */}
            <button
              type="submit"
              className="w-fit bg-secondary hover:bg-red-700 text-white font-bold py-2.5 px-8 rounded-sm transition-colors uppercase text-sm"
            >
              Đăng nhập
            </button>
